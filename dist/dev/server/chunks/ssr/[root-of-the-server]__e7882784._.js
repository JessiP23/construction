...
function getI18nInstance() {
    ...
    const i18n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$i18next$2f$dist$2f$esm$2f$i18next$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createInstance"])();
    i18n.use(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$i18next$2f$dist$2f$es$2f$initReactI18next$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["initReactI18next"]).init({
        resources,
        lng: "en",
        fallbackLng: "en",
        interpolation: {
...
async function generateMetadata({ params }) {
    const specialty = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$specialties$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSpecialtyBySlug"])(params.slug);
    if (!specialty) {
        return {};
    }
    const i18n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$i18n$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getI18nInstance"])();
    const copy = i18n.t(`specialties.items.${specialty.id}`, {
        returnObjects: true
    });
    return {
        title: `${copy.name} | Titino Construction`,
        description: copy.seoDescription ?? i18n.t("specialties.description")
    };
}
function SpecialtyPage({ params }) {
    const specialty = (0, __TURBOPACK__imported__module__$5b$project$5d2f$data$2f$specialties$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSpecialtyBySlug"])(params.slug);
    if (!specialty) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e7882784._.js.map